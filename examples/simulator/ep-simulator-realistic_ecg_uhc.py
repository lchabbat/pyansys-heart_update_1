...
from ansys.health.heart.settings.settings import Purkinje
...
# Initialize fascicle endpoints using UHC coordinates
lpf_endpoint_uhc = [0.0, 0.639, 2.469]  
user_fascicle_endpoint_uhc = [0.0, 0.866, -2.589]  
laf_endpoint_uhc = [0.0, 0.81, 2.5951]
...
left_anterio_fascile = ConductionPath.create_from_keypoints(
    ...
    keypoints=[simulator.model._landmarks.his_left_end_node.xyz, get_xyz_from_uhc(simulator.model.mesh, laf_endpoint_uhc)],  
...
left_posterior_fascile = ConductionPath.create_from_keypoints(
    ...
    keypoints=[simulator.model._landmarks.his_left_end_node.xyz, get_xyz_from_uhc(simulator.model.mesh,lpf_endpoint_uhc)],  
    id=13,
    base_mesh=model.left_ventricle.endocardium,
    connection=None,
    line_length=None,
...
left_user_defined_fascicle = ConductionPath.create_from_keypoints(
    ...
    keypoints=[simulator.model._landmarks.his_left_end_node.xyz, get_xyz_from_uhc(simulator.model.mesh, user_fascicle_endpoint_uhc)],   
    id=14,
    base_mesh=model.left_ventricle.endocardium,
    connection=None,
    line_length=None,
